...
; FileGetAttrib, OutputVar, C:\Users\Dianbo\Desktop\test.png
; MsgBox % OutputVar
; FileSetAttrib, +N , C:\Users\Dianbo\Desktop\test.png
...
Gui, Add, Checkbox, xm y+3 vSubTree, 在子树中
Gui, Add, Checkbox, x+5 yp vFiles Checked, 文件
Gui, Add, Checkbox, x+5 yp vFolders Checked, 文件夹
Gui, Add, Checkbox, x+5 yp vAttr, 属性
Gui, Add, Checkbox, x+5 yp vSize, 尺寸
Gui, Add, Checkbox, x+5 yp vWrite, 最后写入
Gui, Add, Checkbox, x+5 yp vAccess, 最后访问
Gui, Add, Checkbox, x+5 yp vCreation, 创建
Gui, Add, Checkbox, x+5 yp vSecurity, 安全性
Gui, Add, ListView, xm w800 r15 vLV, 操作时间|文件夹|行为|名称|目录|旧名称|%A_Space%
